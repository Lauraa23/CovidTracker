  ...
  return (
    <>
      ...
      >
        ...
        <div className="preventWrapperContainer flex flex-row items-center justify-center">
          <div className="preventCardsLeft flex flex-col w-2/5">
            <div className="preventExplanation flex gap-5 items-center text-left">
              <div className="mainImageContainer flex flex-col items-center justify-center w-2/5 transition-transform duration-[0.3s] ease-[ease]">
                <div className="hexImageContainer h-[4em] relative w-[6.8em] bg-white transition-transform duration-[0.3s] ease-[ease] mx-0 my-[3.4641em] before:content-[''] before:h-0 before:absolute before:top-[-2em] before:w-0 before:border-b-[2em] before:border-b-white before:border-x-[3.4641em] before:border-x-transparent before:border-solid before:inset-x-0 after:bottom-[-2em] after:content-[''] after:h-0 after:absolute after:w-0 after:border-t-[2em] after:border-t-white after:border-x-[3.4641em] after:border-x-transparent after:border-solid after:inset-x-0"></div>
                <img
                  className="w-[7%] absolute transition-transform duration-[0.3s] ease-[ease]"
                  src="/assets/icons/avoid.png"
                  alt="personalContact"
                />
              </div>
              <div className="preventTextContent">
                <h4 className="text-[0.9rem] text-[#262f5a] font-bold">
                  Personal Contact
                </h4>
                <p className="text-xs text-start text-[#262f5a]">
